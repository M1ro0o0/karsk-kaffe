const en = {
  ...
  footer: {
    rights: "Karsk Kaffe. All rights reserved.",
  },
  ...
  labels: {
    ...
    roastingDegree: "Roasting degree",
    region: "Region",
    subregion: "Subregion",
    harvest: "Harvest",
    owner: "Owner",
  ...
  cart: {
    empty: "It is coffee o'clock.",
    empty2: "Grab something for yourself!",
    cart: "Your Cart",
  ...
  about: {
    ...
    text41: "A small team with great passion and an even bigger heart for coffee. Meet (from left to right) Aďo, Aťa, Sima, Parik, and Jana – the people behind those steaming cups of coffee. With six years of experience in the craft, they continue to improve every day. Starting small, they gradually expanded from a few carefully crafted blends to offering 12 different types of coffee today. They always bring something new to the table.",
    ...
    text45: "In 2025, they visited this farm, as well as La Promesa farm and the farm of Carolina Hurtado in Colombia, and took part in harvesting coffee cherries to gain a deeper connection to the entire coffee production process. They realized that coffee is not just about pouring hot water over ground coffee, but that it grows, ripens, and must be harvested, often by hand. From a small sprout to that delicious cup of hot brown gold.",
