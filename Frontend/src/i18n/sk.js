const sk = {
  ...
  footer: {
    rights: "Karsk Kaffe. Všetky práva vyhradené.",
  },

  home: {
    /*Zatiaľ nie je žiadny text na preklad*/
  },

  product: {
    loading: "Načítava sa produkt",
    like: "Tiež by sa Vám mohlo páčiť",
    priceFrom: "Od",
  ...
  labels: {
    tasteProfile: "Chuťový profil",
    origin: "Pôvod",
    processing: "Spracovanie",
    processingFarm: "Spracujύca farma",
    roastingDegree: "Stupeň praženia",
    region: "Región",
    subregion: "Podregión",
    harvest: "Zber",
    owner: "Vlastník",
  ...
  cart: {
    empty: "Je čas na kávu.",
    empty2: "Vyberte si niečo pre seba!",
    cart: "Váš košík",
    pPerPcs: "Cena za ks",
    VAT: "DPH",
    total: "Spolu",
  ...
  address: {
    bill: "Fakturačná adresa",
    ship: "Dodacia adresa",
    name: "Meno",
    firstName: "Meno (stredné meno)",
    lastName: "Priezvisko",
    contact: "Kontakt",
    email: "E-mail",
    code: "PSČ",
 ...
 about: {
    ...
    text45: "V roku 2025 navštívili túto farmu, ale aj farmu La Promesa a farmu Caroliny Hurtado v Kolumbii a zúčastnili sa zberu kávových čerešní, aby sa hlbšie prepojili s celým procesom vzniku kávy. Pochopili, že káva nie je len o zalievaní mletej kávy horúcou vodou, ale že rastie, dozrieva a musí byť zberaná, väčšinou ručne. Od malého výhonku až po tú lahodnú šálku horúceho hnedého zlata.",
